...
export function OpenAiDialog({
  ...
  const credentials = useCredentialsByType(CredentialType.OPENAI);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Generate text via OpenAI. Prompts support <code className="font-mono">{`{{varName.field}}`}</code> templating.
          </DialogDescription>
        </DialogHeader>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      rows={5}
                      placeholder="Write me an email for {{json googleForm.responses}}"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
