...
export function GeminiDialog({
  ...
  const credentials = useCredentialsByType(CredentialType.GEMINI);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Generate text via Google Gemini. Prompts support{" "}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      rows={5}
                      placeholder="Translate {{json googleForm.responses}} to Indonesian"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
